...
export function getStepReminder(
  ...
  const reminders: Record<ChatLang, Record<string, string>> = {
    pt: {
      ...
      SHOW_FLEET: "Escolha um veículo abaixo ou diga «quero SUV» / «clio».",
      ASK_PROTECTION: "Prefere *Franquia ZERO* ou *Standard*? Pode perguntar-me a diferença.",
      SHOW_TERMS: "Leia as condições e toque em *aceitar o contrato* para continuar.",
      SHOW_QUOTE: "Revise o orçamento e toque em *aceitar* ou peça alterações.",
      PAYMENT: "Confirme o pagamento do sinal para reservar.",
      DOCS: "Envie fotos do passaporte e carta de condução com o botão.",
